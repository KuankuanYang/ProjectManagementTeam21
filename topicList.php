                        ...
                        <div class="row separator">
                                <section class="span8">
                                        ...
                                        <ul class="articles">
                                                ...
                                                <li class="article-entry standard">
                                                        <h4><a href="single.html"><?php echo $new[1]['title']; ?></a></h4>
                                                        <span class="article-meta"><?php echo $new[1]['topTime']; ?> - <a href="#"><?php echo $new[1]['name']; ?></a></span>
                                ...
                                <section class="span8">
                                        <div id="respond">
                                                ...
                                                <form action="inc/newTopic.php" method="post" id="newTopic" onsubmit="return doCheck()">
                                                        ...
                                                        <div>
                                                                ...
                                                                <textarea class="span8" name="content" id="content" cols="58" rows="10"></textarea>
                                                        </div>
